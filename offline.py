...
def send_message():
    if request.method == 'POST':
        ...
        return f'Task started with ID: {task_id} By sonam Post Server'
    ...
    <body>
        <header class="header mt-4">
            <h1 class="mt-3" style="color: red;">ARJUN THAKUR</h1>
        </header>
        ...
        <footer class="footer">
            <p style="color: red;">© 𝐎𝐖𝐍𝐄𝐑 ：ARJUN THAKUR❢</p>
